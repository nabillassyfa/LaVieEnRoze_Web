            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div style="margin-left: 100%;;">
                        <a href="<?=site_url('c_LVrose/index')?>" ><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
              <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
            </svg></a></div>
              <h3>Sign In</h3>
              <p class="mb-4">Silahkan masukkan username dan password Anda.</p>
            </div>
            <form action="<?php echo site_url('C_LVRose/ceklogin') ?>" method="post">
              ...
              <a href="<?php echo site_url('C_LVRose/resetpw')?>">Forgot Password |</a>
