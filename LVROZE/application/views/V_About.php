...
<!-- Mirrored from preview.colorlib.com/theme/foodbar/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 01:04:28 GMT -->
<head>
...
<li class="nav-item active"><a class="nav-link" href="<?php echo site_url ('C_LVRose/about')?>">About</a></li>
<li class="nav-item"><a class="nav-link" href="<?php echo site_url ('C_LVRose/linkMenu')?>">Menu</a></li>
<li class="nav-item"><a class="nav-link" href="<?php echo site_url ('C_LVRose/reservasi')?>">book a table</a></li>
...
<a href="<?php echo site_url ('C_LVRose/about')?>">About Us</a>
</div>
</div>
</div>
...
<hr>
<p>Restoran ini berdiri dari tahun 2020 dan menjadi restoran dengan pengunjung terbanyak selama 2 tahun berturut-turut.</p>
<p>Kami berdedikasi untuk membuat pelanggan merasakan citra rasa Korea alami yang tergambarkan dalam rasa dari makanan baik minuman yang kami buat.</p>
<a class="main_btn" href="<?php echo site_url ('C_LVRose/linkMenu')?>">View Full Menu</a>
</div>
</div>
<div class="col-lg-6">
<div class="story_img">
<img class="img-fluid" src="<?php echo base_url('img/resto.jpg');?>" alt="">
</div>
</div>
</div>
</div>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon='{"rayId":"7ca0a90d69a44ab5","version":"2023.4.0","b":1,"token":"cd0b4b3a733644fc843ef0b185f98241","si":100}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from preview.colorlib.com/theme/foodbar/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 01:04:31 GMT -->
</html>