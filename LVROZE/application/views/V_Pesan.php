...
<a href="<?php echo site_url ('C_LVRose/reservasi')?>">Book </a>
</div>
</div>
</div>
...
<h3>Log in</h3>
<form class="book_table_form row" action="<?= site_url('C_LVRose/createAction') ?>" method="post">
<div class="form-group col-md-12">
<label for="exampleFormControlInput1" class="form-label">Username</label>
<input type="text" class="form-control" id="name" name="nama_pelanggan" placeholder="Masukkan Username" required>
</div>
<div class="form-group col-md-12">
<label for="exampleFormControlInput1" class="form-label">Password</label>
<input type="text" class="form-control" id="no_meja" name="no_meja" placeholder="Masukkan Password" required>
</div>
<div class="container">
  <div class="form-group col-md-12">
  <button type="submit" value="submit" class="btn submit_btn form-control">Log In</button>
  </div>
  <a href="about.html">Forgot Password</a>
  <a href="#">|</a>
  <a href="<?php echo site_url('C_LVRose/linksignup')?>">Sign up</a>
</div>
</form>
</div>
</div>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon='{"rayId":"7ca0a91c0c184ab5","version":"2023.4.0","b":1,"token":"cd0b4b3a733644fc843ef0b185f98241","si":100}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from preview.colorlib.com/theme/foodbar/book-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 May 2023 01:04:33 GMT -->
</html>