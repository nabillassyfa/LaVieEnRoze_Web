...
<title>Menu</title>
        ...
        <link rel="stylesheet" href=".../.../plugins/sweetalert2-theme-bootstarp-4/bootstrap-4.min.css">
...
<li class="nav-item active"><a class="nav-link" href="<?php echo site_url ('C_LVRose/menulogin')?>">Menu    <?php
        $keranjang = ' Keranjang: '.$this->cart->total_items(). 'items'
    ?>
    <?php echo anchor(site_url('C_LVRose/detail'), $keranjang) ?>  </a></li>
                    ...
                    <div class="menu_list">
                        <ul class="list">
                            ...
                            <li>
                                ...
                                <p><?= $data->keterangan ?></p>
                                <?php echo anchor('C_LVRose/tambah_keranjang/'. $data->id_menu, '<div class="btn btn-sm btn-primary">Tambah ke Keranjang</div>')?> 
                            </li>
                            <?php
			                    $cacah++;
		                        }
