...
<li class="nav-item active"><a class="nav-link" href="<?php echo site_url ('C_LVRose/klogin')?>">Contact</a></li>
</ul>
</div>
</div>
</nav>
...
<a href="<?php echo site_url ('C_LVRose/kontak')?>">Contact Us</a>
</div>
</div>
</div>
...
<div class="map-section">
  <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31819.368360046334!2d129.8682241681166!3d-4.517901019975405!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2d15860b887ac3ab%3A0x6d9d8565c44e2f07!2sBanda%20Neira!5e0!3m2!1sid!2sid!4v1680922745582!5m2!1sid!2sid" frameborder="0" allowfullscreen></iframe>
</div>
<br>
<div class="row">
<div class="col-lg-3">
...
<h6><a href="#"><span class="__cf_email__" >lvrosee@lv.com</span></a></h6>
<p>Send us your query anytime!</p>
</div>
</div>
</div>
<div class="col-lg-9">
<form class="row contact_form" action="<?= site_url('C_LVRose/createActionContact')?>" method="post" id="contactForm" novalidate="novalidate">
<div class="col-md-6">
<div class="form-group">
<input type="text" class="form-control" id="nama_pengirim" name="nama_pengirim" placeholder="Enter your name" required>
</div>
<div class="form-group">
<input type="text" class="form-control" id="subjek_pesan" name="subjek_pesan" placeholder="Enter Subject" required>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<textarea class="form-control" name="isi_pesan" id="isi_pesan" rows="1" placeholder="Enter Message" required></textarea>
</div>
</div>
