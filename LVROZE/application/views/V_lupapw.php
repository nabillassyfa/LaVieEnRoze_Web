      ...
      <div class="row">
        ...
        <div class="col-md-6 contents">
            <div class="row justify-content-center">
              ...
              <h3>Sign In</h3>
              <p class="mb-4">Silahkan masukkan password dan password Anda.</p>
            </div>
            <form action="<?= site_url('C_LVRose/updatepw/' . $id_user) ?>" method="post">
              <div class="form-group first">
                <label for="password">Password</label>
                <input type="password" class="form-control" id="pass" name="pass" required>
              </div>
              <input type="submit" value="Perbaharui Password" class="btn btn-block btn-secondary">
            </form>
            </div>
          </div>
