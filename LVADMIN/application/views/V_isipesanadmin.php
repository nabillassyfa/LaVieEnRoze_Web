        ...
        <div class="card my-5">
            <div class="card-header">
                <div class="card-toolbar">
                    <a href="<?= site_url('C_LVRoze/kontak') ?>" class="btn submit_btn form-control">Kembali</a>
                </div>
            </div>
            <div class="card-body">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <p class="banner_content text">Nama Pengirim</p>
                        </div>
                        <div class="col-lg-7">
                            <p class="banner_content text"><?= $data->nama_pengirim?></p>
                        </div>
                        <div class="col-lg-5">
                            <p class="banner_content text">Subjek Pesan</p>
                        </div>
                        <div class="col-lg-7">
                            <p class="banner_content text"><?= $data->subjek_pesan?></p>
                        </div>
                        <div class="col-lg-5">
                            <p class="banner_content text">Isi Pesan</p>
                        </div>
                        <div class="col-lg-7">
                            <p class="banner_content text"><?= $data->isi_pesan?></p>
                        </div>
                    </div>
                </div>
            </div>
