                ...
                <div class="container">
                    <div class="banner_content text-center">
                        ...
                        <div class="page_link">
                            ...
                            <a href="book-table.html">Data Reservasi</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card my-5">
                <div class="card-header">
                    <div class="card-toolbar">
                        <a href="<?= site_url('C_LVRoze/reservasi') ?>" class="btn btn-success btn-sm"> Kembali</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-5">
                                <p class="lead">Nama Pelanggan</p>
                            </div>
                            <div class="col-lg-7">
                                <p class="lead"><?= $data->nama_pelanggan ?></p>
                            </div>
                            <div class="col-lg-5">
                                <p class="lead">No Telepone Pelanggan</p>
                            </div>
                            <div class="col-lg-7">
                                <p class="lead"><?= $data->no_telp_pelanggan ?></p>
                            </div>
                            <div class="col-lg-5">
                                <p class="lead">Email Pelanggan</p>
                            </div>
                            <div class="col-lg-7">
                                <p class="lead"><?= $data->email?></p>
                            </div>
                            <div class="col-lg-5">
                                <p class="lead">Tanggal Reservasi</p>
                            </div>
                            <div class="col-lg-7">
                                <p class="lead"><?= $data->tanggal_reservasi?></p>
                            </div>
                            <div class="col-lg-5">
                                <p class="lead">Waktu Reservasi</p>
                            </div>
                            <div class="col-lg-7">
                                <p class="lead"><?= $data->jam_reservasi?></p>
                            </div>
                            <div class="col-lg-5">
                                <p class="lead">Jumlah Orang</p>
                            </div>
                            <div class="col-lg-7">
                                <p class="lead"><?= $data->jumlah_orang?></p>
                            </div>
                        </div>
                    </div>
                    </div>
