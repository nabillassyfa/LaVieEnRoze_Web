...
<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="<?php echo site_url ('C_LVRoze/reservasi')?>">Data Reservasi</a></li>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                        <a href="<?= site_url('C_LVRoze/detailrev/'. $value->id_pelanggan) ?>" class="btn btn-sm btn-info text-white">Detail</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php } ?>
