...
<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
              ...
              <li class="nav-item active"><a class="nav-link" href="<?php echo site_url ('C_LVRoze/dtuser')?>">User</a></li>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                        <a href="<?= site_url('C_LVRoze/dataus/'. $value->id_user) ?>" class="btn btn-sm btn-info text-white">Detail</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php } ?>
